 ...
 */
final class Version20210506084202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rencontres (id INT AUTO_INCREMENT NOT NULL, equipe_rencontre_id INT DEFAULT NULL, date_rencontre DATETIME NOT NULL, adversaire VARCHAR(100) NOT NULL, domicile TINYINT(1) NOT NULL, no_journee INT NOT NULL, victoire TINYINT(1) DEFAULT NULL, phase INT DEFAULT NULL, UNIQUE INDEX UNIQ_C5F35DFBEAE54A3D (equipe_rencontre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
